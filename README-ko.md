...
| `workpm-mcp` | PM 모드 (MCP 전용) - Claude, Codex, Gemini 모두 동작 |
| `pmworker` | Worker 모드 - 태스크 담당, 파일 락, 실행, 보고 (모든 CLI) |
...
| 🧪 **테스트** | code-reviewer, api-tester, qa-test-planner, qpassenger | 코드 리뷰 & QA |
