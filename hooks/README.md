...
| impeccable-detect.mjs | UI 파일 디자인 안티패턴 검출 (impeccable 59규칙, `npx impeccable detect`) — Node 단일 파일, 항상 exit 0, 발견은 `additionalContext` JSON으로 모델에 주입 | PostToolUse (Edit/Write/MultiEdit) |
