...
| 🔮 **Meta** | agent-md-refactor, command-creator, plugin-forge, skill-judge, find-skills, manage-skills, project-gotchas, verify-implementation | Plugin/skill creation/verification tools + auto gotcha management |
