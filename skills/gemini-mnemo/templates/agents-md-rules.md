...
설치된 모든 스킬은 `~/.gemini/SKILLS-CATALOG.md`, 에이전트는 `~/.gemini/AGENTS-CATALOG.md`에 목록화되어 있습니다.

**조회 순서:**
1. Gemini 전역 카탈로그: `~/.gemini/SKILLS-CATALOG.md`, `~/.gemini/AGENTS-CATALOG.md`
2. 현재 프로젝트에 실제 파일이 있을 때만: `./SKILLS-CATALOG.md`, `./AGENTS-CATALOG.md`
3. 둘 다 없으면 오류로 멈추지 말고 `~/.gemini/skills/*/SKILL.md`, `~/.gemini/agents/*.md`를 직접 탐색
