...
Phase 2: [도면 작성] /flow-verifier plan → .mmd 생성
Phase 2:   구현 (도면의 노드별 태스크 배분)
Phase 4: [공정 점검] /flow-verifier verify → 매칭 검증
           ├─ FULL MATCH → 최종 보고
...
| `skills/orchestrator/commands/workpm.md` | PM Agent Teams 모드 (Phase 2/4 연동) |
| `skills/orchestrator/commands/workpm-mcp.md` | PM MCP 모드 (Phase 2/4 연동) |
