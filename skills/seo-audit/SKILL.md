...
| 카테고리 | 영역 |
|---------|------|
| **SEO** (전통) | 1. robots.txt · 2. Sitemap · 3. 메타태그 · 4. 구조화 데이터 · 5. 이미지 · 6. 링크 · 7. 성능 |
| **AEO/GEO** (AI) | 8. AI 크롤러 접근성 · 9. AEO(답변 엔진) · 10. GEO(생성형 AI) |
...
> **AEO/GEO 심각도 참고**: AI 검색에서의 가시성은 빠르게 중요해지고 있습니다.
