...
description: Use when AGENTS.md, CLAUDE.md, or similar instruction files are bloated (300+ lines). Splits monolithic files into organized, linked documentation following progressive disclosure principles.
license: MIT
---
...
└── docs/agent-instructions/      # Runtime-neutral detailed rules
    ├── typescript.md
    ├── testing.md
    ├── code-style.md
    ├── git-workflow.md
...
- [Architecture Patterns](docs/agent-instructions/architecture.md)
```
...
- [TypeScript](docs/agent-instructions/typescript.md)
```
