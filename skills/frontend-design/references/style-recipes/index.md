...
1. **아프로디테 Phase 1**: 먼저 `coder-interface-pattern-playbook.md`로 기능형/표현형과 효과 예산을 판별한 뒤, 아래 매핑의 **후보 풀**에서 레시피 2~3개를 카드로 제시.
...
아프로디테 Phase 1에서 프리셋 선택 후 이 풀에서 2~3개를 고릅니다. 풀 안의 순서는 우선순위가 아닙니다.
