...
description: QA 시나리오 기반 Playwright 테스트 자동 생성 + 브라우저 탐색 QA + fix-until-pass 루프 (큐패신저)
---
...
/qpassenger --explore-only            # 브라우저 탐색 QA만 실행
/qpassenger --no-explore              # 브라우저 탐색 QA 스킵
```
